...
export function canAccessPage(role: AuthRole, page: string): boolean {
  const pageAccess: Record<string, AuthRole[]> = {
    '/dashboard': ['TECHNICIAN', 'LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
    ...
    '/dashboard/analytics': ['LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
    '/dashboard/analytics/alerts': ['LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
    '/dashboard/analytics/exports': ['LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
    '/dashboard/analytics/details': ['LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
    '/dashboard/analytics/settings': ['LAB_TECH', 'LAB_MANAGER', 'ADMIN', 'VIEWER'],
